...
displayName: QC Data Processor
description: Use when user asks to analyze QC data (SPC control charts, process capability Cp/Cpk), reliability/Weibull analysis, or generate QC reports. Provides MCP tools for QC data parsing, SPC analysis, reliability fitting, and Markdown report generation.
version: 1.0.0
author: David
license: MIT
metadata:
